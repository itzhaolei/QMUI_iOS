...
/// 默认的 parentView
#define DefaultTipsParentView (UIApplication.sharedApplication.windows.firstObject ? UIApplication.sharedApplication.windows.firstObject : UIApplication.sharedApplication.delegate.window)
